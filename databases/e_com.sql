...
CREATE TABLE IF NOT EXISTS `iic_archives` (
  ...
  `shorttitle` char(120) NOT NULL DEFAULT '' COMMENT '短标题',
  ...
  `keywords` char(130) NOT NULL DEFAULT '' COMMENT '关键字',
  ...
  `my_content` mediumtext DEFAULT '' COMMENT '页面摘要',
  ...
  `picurl` varchar(150) DEFAULT '' COMMENT '封面图片',
...
CREATE TABLE `iic_ltd` (
  ...
  `title` varchar(150) DEFAULT NULL COMMENT '公司名称',
...
CREATE TABLE IF NOT EXISTS `iic_feedback` (
  ...
  `arctitle` varchar(160) NOT NULL DEFAULT '' COMMENT '标题',
...
CREATE TABLE IF NOT EXISTS `iic_flink` (
  ...
  `webname` char(130) NOT NULL DEFAULT '' COMMENT '网站名称',
...
CREATE TABLE IF NOT EXISTS `iic_album` (
  ...
  `aid` mediumint(8) NOT NULL DEFAULT '0' COMMENT '档案信息ID',
  `albumname` varchar(150) NOT NULL default '' COMMENT '相册名字',
  ...
  `password` varchar(32) NOT NULL default '' COMMENT '相册密码',
...
CREATE TABLE IF NOT EXISTS `iic_group` (
  ...
  `groupname` varchar(100) NOT NULL COMMENT '群组名称',
  `tags` varchar(150) NOT NULL default '' COMMENT '相关标签',
