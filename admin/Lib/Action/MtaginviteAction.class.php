<?php
class MtaginviteAction extends PublicAction{
	...
	public function ajaxlist(){
		...
		$feilds='uid,username,tagid,fromuid,fromusername,dateline,endtime,id';
	...
	public function edit(){
		...
		$this->assign("fromusername",$list["fromusername"]);
