<?php
class FairAction extends PublicAction{
	...
	public function ajaxlist(){
		...
		$feilds='aid,starttime,endtime,visitor,exhibitor,product,website,id';
	...
	public function edit(){
		...
		$this->assign("visitor",$list["visitor"]);
		$this->assign("exhibitor",$list["exhibitor"]);
		$this->assign("product",$list["product"]);
		$this->assign("website",$list["website"]);
