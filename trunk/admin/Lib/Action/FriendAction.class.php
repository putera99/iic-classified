<?php
class FriendAction extends PublicAction{
	...
	public function ajaxlist(){
		...
		$feilds='uid,fuid,fusername,status,gid,note,num,dateline,mtime,id';
	...
	public function edit(){
		...
		$this->assign("fusername",$list["fusername"]);
		$this->assign("status",$list["status"]);
		$this->assign("gid",$list["gid"]);
		$this->assign("note",$list["note"]);
