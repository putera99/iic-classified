<?php
class EventAction extends PublicAction{
	...
	public function ajaxlist(){
		...
		$feilds='aid,deadline,starttime,endtime,public,membernum,attending,mightatten,notattending,detail,id';
	...
	public function edit(){
		...
		$this->assign("deadline",$list["deadline"]);
		$this->assign("starttime",$list["starttime"]);
		$this->assign("endtime",$list["endtime"]);
		$this->assign("public",$list["public"]);
		$this->assign("membernum",$list["membernum"]);
		$this->assign("attending",$list["attending"]);
		$this->assign("mightatten",$list["mightatten"]);
		$this->assign("notattending",$list["notattending"]);
		$this->assign("detail",$list["detail"]);
