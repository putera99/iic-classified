<?php
class AddonCommerceAction extends PublicAction{
	...
	public function ajaxlist(){
		...
		$feilds='aid,quantity,price,content,id';
	...
	public function edit(){
		//买卖_edit
		$result=D("AddonCommerce");
		$list=$result->getById($_GET['id']);
		$this->assign('list',$list);
				$this->assign("id",$list["id"]);
		$this->assign("aid",$list["aid"]);
		$this->assign("quantity",$list["quantity"]);
