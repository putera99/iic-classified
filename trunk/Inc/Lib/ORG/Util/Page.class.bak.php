...
class Page extends Think {
     ...
     * @param array $parameter  分页跳转的参数
     +----------------------------------------------------------
     */
    public function __construct($totalRows,$listRows,$url=array(),$parameter='') {
    	$this->url=$url;
    ...
    public function show() {
        ...
        $url  =empty($this->url)?$_SERVER['REQUEST_URI'].(strpos($_SERVER['REQUEST_URI'],'?')?'':"?").$this->parameter:$this->url.$this->parameter;
        $parse = parse_url($url);
